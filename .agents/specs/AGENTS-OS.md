🛸 KONSTYTUCJA AGENTS-OS v6.5 Swarm Edition — Instrukcja obsługi
Wersja: 6.5-AG | Status: STABLE | Architekt: Antigravity Orchestrator & GEM (Gemini Evolution Manager)
...
Wersja 6.5 wprowadza samowystarczalny system zapobiegania halucynacjom modeli LLM (Anti-Hallucination Matrix):
