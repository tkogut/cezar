...
4. Loop until `om-auto-review-pr` returns a clean verdict (no actionable blockers) or the remaining findings are non-actionable (out of scope, false positive) — document those explicitly in one PR comment; later reports link it.
